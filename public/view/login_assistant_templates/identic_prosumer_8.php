<form id="form" action= "<?php get_page_by_title($pagetitle)?>"; method="post" enctype="multipart/form-data">
	...
	<div class="verbrauchsstelle">	
		<div class ="fancy-input">
			...
			<input type="text" name="strasse_verbrauch" id="strasse_verbrauch" value="<?php echo wp_kses_post($strasse_pv); ?>"/>
			<input type="text" name="hausnr_verbrauch" id="hausnr_verbrauch" value="<?php echo wp_kses_post($hausnr_pv); ?>"/>
		</div>	
		<div class ="fancy-input">
			<label for="stadt_verbrauch">PLZ und Ort:</label>
			<input type="text" name="PLZ_verbrauch" id="PLZ_verbrauch" value="<?php echo wp_kses_post($plz_pv); ?>"/>
			<input type="text" name="stadt_verbrauch" id="stadt_verbrauch" value="<?php echo wp_kses_post($stadt_pv); ?>"/><br />
		</div>
	</div><br />
	<body>
